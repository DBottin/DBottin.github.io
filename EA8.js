var app = (function() {
    ...
    var illumination = {
        ...
        light: [
            {
            isOn : true,
            position : [ Math.cos(2 * Math.PI / 60 * 7) * 2.3, 1., Math.sin(2 * Math.PI / 60 * 7) * 2.3 ],
            color : [ 1., 1., 1. ]
            },
            {
            isOn: true,
            position : [ Math.cos(2 * Math.PI / 60 * 7 + Math.PI) * 2.3, 1., Math.sin(2 * Math.PI / 60 * 7 + Math.PI) * 2.3 ],
            color: [1., 1., 1.]
            }        ]
    };
    ...
    function autoAnimate() {
        if (automated == false) {
            loop = window.setInterval(moveLights, 55);
            moveLights();
            automated = true;
        } else {
            automated = false;
    ...
    function moveLights() {
        ...
        illumination.light[0].position[0] = Math.cos(currentLight) * 2.3;
        illumination.light[0].position[2] = Math.sin(currentLight) * 2.3;

        illumination.light[1].position[0] = Math.cos(currentLight + Math.PI) * 2.3;
        illumination.light[1].position[2] = Math.sin(currentLight + Math.PI) * 2.3;
